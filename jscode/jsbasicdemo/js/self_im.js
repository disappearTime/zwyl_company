...
//右键
 ...
 //    });
	...
	$add_open_course.on("change","#addCourseFile",function(){ // 公开课(点播)选择视频文件
		var $this = $(this); 
	...
	$add_open_course.find("#addCourseBtn").on("click",function(){ // 添加课程弹窗确定按钮的点击
		//验证
	...
	$createOperCourse.find("#sendOpenCourse").on("click",function(){ // 点击发布
